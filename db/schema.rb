...
ActiveRecord::Schema.define(version: 20150106180034) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "profile_photo",          default: "http://sellleadsucceed.files.wordpress.com/2014/02/bigstock-silhouette-with-a-question-mar-59367497.jpg"
  end
