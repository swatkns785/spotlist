...
ActiveRecord::Schema.define(version: 20150108201543) do
  ...
  add_index "reviews", ["playlist_id", "user_id"], name: "index_reviews_on_playlist_id_and_user_id", unique: true, using: :btree
